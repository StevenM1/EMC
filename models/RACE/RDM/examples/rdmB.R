...
# Again we construct a series of plausible models to test
...
cirdm_Bvt0 <- plot_density(rdm_Bvt0,layout=c(2,4),selection="mu",subfilter=1500)
...
cirdm_Bvt0_mapped <- plot_density(rdm_Bvt0,layout=c(2,4),
